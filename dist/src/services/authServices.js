...
function signUp(body) {
    return __awaiter(this, void 0, void 0, function () {
        var name, email, password, userExists;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    name = body.name, email = body.email, password = body.password;
                    return [4 /*yield*/, authRepository_1.default.findByEmail(email)];
                case 1:
                    userExists = _a.sent();
                    if (userExists)
                        throw (0, conflictError_1.conflictError)("User");
                    return [4 /*yield*/, authRepository_1.default.insertUser(name, email, password)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function signIn(body) {
    return __awaiter(this, void 0, void 0, function () {
        var email, password, user, passwordMatch, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    user = _a.sent();
                    if (!user)
                        throw (0, notFoundError_1.notFoundError)("Email");
                    passwordMatch = bcrypt_1.default.compareSync(password, user.password);
                    if (!passwordMatch)
                        throw (0, unauthorizedError_1.unauthorizedError)("Password");
